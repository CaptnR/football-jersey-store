"""
Django settings for jersey_store_backend project.
...
SECRET_KEY = 'django-insecure-6h#5l^949-(j=vf3u1gyujsqbsfl+d9!h*sze^0v*t4e^$s&lx'
...
ROOT_URLCONF = 'jersey_store_backend.urls'
...
WSGI_APPLICATION = 'jersey_store_backend.wsgi.application'
